...
safo on  fix/first-qa-bugs [?] ❯ .build/debug/Safo ~/code/safo/README.md
^C

safo on  fix/first-qa-bugs [?] ❯ cd code/safo/.build/debug/Safo
cd: no such file or directory: code/safo/.build/debug/Safo

safo on  fix/first-qa-bugs [?] ❯
...
✔︎ Cask safo (0.1.1)                                  Verified    778.9KB/778.9KB
...
já tinha completado quando corri os comandos acima
...
==> Fetching downloads for: andrefurt/safo/safo
✔︎ Cask safo (0.2.0)                                  Verified    803.3KB/803.3KB
==> Uninstalling Cask safo
==> Backing App 'Safo.app' up to '/opt/homebrew/Caskroom/safo/0.1.1/Safo.app'
==> Removing App '/Applications/Safo.app'
==> Unlinking Binary '/opt/homebrew/bin/safo'
==> Purging files for version 0.1.1 of C...

### Prompt 55

quais são os comandos para abrir?

### Prompt 56

está me a aparecer novamente isso
...
Está a vir novamente com dois icons de sidebar... button no meio, safo escrito em cima, readme duplicado 2 vezes na topbar...
...
já fiz. preciso daqueles comandos para tirar a flag que o mac mete quando abre e não me deixa abrri
...
sim, está a funcionar. mostra um screenshot
...
abriu. e como funciona? tenho que pedir ou é automatico?
...
funcionou mas ele criou uma janela nova do safo e não atualizou a que estava aberta
